...
Attach your identification document (passport, cédula de ciudadanía, cédula de extranjería). This document must be in PDF format and cannot be larger than 1MB.

<img class="w-2/3 m-auto" src="/cmm/cmm-5.png"/>

Accept the terms and conditions and privacy policy, fill out the Captcha and click on "Acepto". At this point, your application will be submitted. It can take some while to load the request.
...
- "Descargar" - Click on this button to download a PDF file with the confirmation that the request has been submitted and an ID code has been assigned. Remember to keep a copy just in case.
...
<img class="w-2/3 m-auto" src="/cmm/cmm-16.png"/>
