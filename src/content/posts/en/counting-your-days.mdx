...
---
import FancyTooltipLink from "../../../components/FancyToolTip";
...
This *quota* is not accumulable. You can't accumulate the days from previous years. You<FancyTooltipLink client:only="react" link="https://example.com"> can't use the days you didn't use in 2022 </FancyTooltipLink> in 2023.
