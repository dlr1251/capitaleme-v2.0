...
readTime: 11 min
image:
    url: '../../../blog/dnv-confusion/img-1.webp'
...
Why do people say that you can only stay for 180 days in a year?
...
### Check if your country is exempted or not


<CountryExcemptionCheck client:load/>

Note that there are 100 countries that are exempt of visa, so if you are coming from Zambia or Turkmenistan, or good old North Korea, you have to find another [visa type](/visas) to bring your activities here.
