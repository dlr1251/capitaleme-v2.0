...
countries: ["TLC"]
popular: false
short_description: Esta categoría de visa está destinada para extranjeros que son titulares de pasaportes de cualquiera de los países con los que Colombia ha suscrito un acuerdo de libre comercio.
---
...
You can find the full list **[here](https://www.tlc.gov.co/acuerdos/vigente)**
...
This visa allows you to stay in Colombia for up to two (2) years. It also allows you to get a foreign ID card (Cédula de extranjería).
...
This visa category is to be applied and [sponsored by a legal entity](https://www.notion.so/Visa-sponsored-by-a-legal-entity-1e1356d1166d48108b2ccce54e28eb1e?pvs=21). Who must provide the following documents:
