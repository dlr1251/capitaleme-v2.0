...
countries: ["Not excempted"]
---
## Foreword
> 💡 Passport holders from any of the [short-term visa exempted countries](https://www.notion.so/e9828c0103b340f998b5af161e146191?pvs=21) do not need to apply for this visa.
...
Since it is a visitor-type (V) visa, this won’t allow you to add time in order to apply for a resident (R) visa.

---

# **How to get the tourism visa**
...
So, basically, you will be required to attach some documents that evidence that you will be staying here as a tourist and not using the tourism visa for other purposes, like looking for work, to study or any other activities that are better suited for another category of visa application.
...
[Sample letter EN](https://www.notion.so/Sample-letter-EN-79d9549ca1d84ef2a531dacdbc1a86ce?pvs=21)

[Sample Letter ES](https://www.notion.so/Sample-Letter-ES-7b2cba3583524dafa2a754c7ed11df11?pvs=21)
...
You must provide a photocopy of the frontpage (where your personal data is) of your passport, which, as mentioned before, must be from any of the short-term visa excempted countries. Your passport must be valid for at least six (6) months beyond the date of your visa application. If your passport is only valid for less than six months prior to the date you'll be applying for your visa, you must renew before applying.
...
| Concept | Other countries | Europe and Cuba (EUR) |
| --- | --- | --- |
| Visa study | $54.92 USD | 42.25 EUR |
| Visa issuance | $82 USD | 40 EUR |

---

## Application process

This process [is common to any type of visa application](https://www.notion.so/General-visa-application-rules-1dc2c565143e4adb95086f993f184e36?pvs=21), and includes the form submission, the payment for visa study fees and visa approval and registration, among other details. Please refer to the following list:
...
The moment to apply depends on each individual’s travel plans. But keep in mind that this process can take up to 30 - 40 days. 
...
There is no restriction on how many times you can enter and exit the country during the vigency of the visa.