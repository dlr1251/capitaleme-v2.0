...
import ExcemptedCountries from '../../../components/en/resources/CountryExcemptionCheck'

## Am I eligible for this visa?

If you are a remote worker, entrepreneur, freelance or employee of a foreign company, and you are a [national from any of the countries exempt from short-stay visas](https://www.capitaleme.com/resources/visa-exempted-countries) for Colombia, you are eligible to apply for this visa.

### Check if you can apply

<ExcemptedCountries dnv={true} client:load/>
...
It allows you to live and work remotely from Colombia for up to two (2) years. Normally they give one year.
It also allows you to get a foreign ID card (Cédula de extranjería).

Although some people say is valid only for 6 months, [this is not true](https://www.capitaleme.com/blog/counting-your-days). TL;DR. It is valid for up to two (2) years, not 180 days as many say*.*
...
This requirement can be met in different manners, depending on wether you are applying as 
a) An employee; 
b) An independent contractor (freelancer); 
c) An entrepreneur – founder / owner of a foreign company; or 
d) As a digital entrepreneur.
...
2. The option to cancel at any time
3. Quick and online purchase process (within one business day)
4. Issuance of a health coverage summary in Spanish
5. Successful use by many of our clients in obtaining their visas

### 3. Personal bank statements

Provide your personal bank statements from the three months prior to the visa application. 
...
Hiring our {frontmatter.title.slice(3)} Visa Assistance service is just *$1,075,000 COP*