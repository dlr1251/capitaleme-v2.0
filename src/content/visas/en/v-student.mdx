...
The Colombian student visa allows its holder to stay, live and study in the country at an ***officially recognized institution or program*** for up to 2 years. 

Passport holders from any of the short-term visa exempted countries or territories normally can study and take lessons or courses in Colombia as long as their stay in the country doesn't exceed 180 calendar days, they can fully enjoy their educational experience without worrying about visa formalities.

If the foreigner comes from a different country, or if the program or course has a length greater than 6 months, the foreigner must apply for this visa to comply with the migratory rules. Also, consider that every school, university or institution may have their own rules for accepting students and are independent from the migratory rules.

If you are planning to apply for this visa category, you must make sure that the course or program you are enrolling to is officially recognized by the Colombian government at any educational level and that they will issue the necessary documents and evidence to attach for your visa application. The Colombian education system levels include public and private institutions for  elementary school, high school, University exchange programs, masters and doctorates. 

Also, some other programs and courses are recognized by the Colombian government such as language learning institutions, among others.  

It is important to note that the student visa is intended for individuals who will be studying **at least ten (10) hours per week during the whole duration of the program** and not for those who wish to travel to Colombia as tourists and take occasional classes.

<aside>
💡 When a school or University is supporting a visa application for a foreign student, they must comply certain migratory rules, specially, they must report the student’s enrollment and assistance to the classes. In that sense, if the student does not show up to classes, the institution must report this to the authorities, causing the cancellation of the visa.

</aside>

For second and further visas applications (even if they are not student visas), you will need to show evidence that you have successfully finished the studies program. 

This visa category belongs to the visitor type (V), meaning that it doesn’t allow the foreigner to accrue time towards residency.

Unless the program allow virtual or at-distance education, if the foreigner stays out of the country for more than 90 days it will cause the automatic termination of the visa.

## What are the benefits and restrictions for this visa?

### **Validity depends on the length of the program**

This visa allows you to stay and study for up to two (2) years, depending on the duration of the program.

### **No beneficiaries except for post-graduate students**

This visa does not allow applications for beneficiaries, except for postgraduate students.

### **Work permit only for post-graduate students**

This type of visa does not allow you to work in Colombia for Colombian companies, since it doesn’t have a work permit, unless you are enrolled in a postgraduate program, such as a Master, a Doctorate or specialization, in which case you will be allowed to work up to twenty (20) hours per week, provided that the employer reports such circumstance to Migración Colombia.
...
As with [any visa application](/blog/post-2), the process is done online, through the Ministry for Foreign Relationship’s website. on this form, other than providing your personal, professional and family information and data, you will be required to attach some documents that are described here below.

In order to apply for this visa, you will need to show evidence that you have been accepted on a studies program and that you have enough financial solvency to live in the country.

The specific requirements for a student visa may vary depending on your sponsorship. If you are applying **with the sponsorship of a Colombian host**, you will need to provide documentation of your sponsor's financial solvency and the sponsor’s motivational letter. If you are applying with **the sponsorship of an educational institution**, they will present the application on your behalf. If you are applying **on your own behalf**, you will need to provide documentation of your own financial solvency and a motivational letter.
...
[Sample letter EN](https://www.notion.so/Sample-letter-EN-18c3003f03db4459bb15a0516cf22507?pvs=21)

[Sample Letter ES](https://www.notion.so/Sample-Letter-ES-d780049a5a52454aa6260d20574a9250?pvs=21)
...
### Sponsored by **a Colombian educational institution**

If you are [applying with the sponsorship of a Colombian certified institution](https://www.notion.so/1e1356d1166d48108b2ccce54e28eb1e?pvs=21), then the **application must be submitted directly by the sponsor.**

Normally, your school will know how to proceed, but just for your information, here’s what they need to do:
...
### 2. **The entrance stamp, its extension, previous visa or salvoconducto**
...
We recommend using [Genki](https://genki.world/?with=capitaleme). Genki has the required coverage plus: 
...
5. They issue a health coverage summary in spanish (aswell as in engligh, german, italian…) 
6. has been successfully used by many of our clients who have gotten their visas approved.

---

<aside>
💡 **Consider that, according to the current visa rules, all documents produced abroad must be duly apostilled and officially translated by a certified Colombian translator. These documents can’t be more than 90 days old at the time of the visa application.**
</aside>
