...
function Calculator({ initialValue }: CalculatorProps) {
  const UVT = 49065;
  ...
  const fees = [
    { name: 'Honorarios Notariales', amount: notaryFee, percentage: '0.27%', color: 'blue' },
    { name: 'Gastos de Registro', amount: registrationFee, percentage: '1.67%', color: 'green' },
    { name: 'Gastos de Rentas', amount: rentasFee, percentage: '1%', color: 'purple' },
    { name: 'Comisión de Corretaje', amount: brokerageFee, percentage: '0.6%', color: 'orange' },
    { name: 'GMF', amount: gmfFee, percentage: '0.4%', color: 'red' },
    { name: 'Impuesto de Timbre', amount: stampDuty, percentage: 'Variable', color: 'indigo' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Calcula tus
            <span className="block text-emerald-600">Gastos de Propiedad</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Obtén una estimación precisa de todos los gastos involucrados en tu transacción inmobiliaria colombiana. 
            Nuestra calculadora incluye honorarios notariales, costos de registro y todos los impuestos aplicables.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                {isLoading ? (
                  <div className="animate-pulse bg-white/20 rounded px-3 py-1">Cargando...</div>
                ) : (
          ...
          <div className="p-8">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">
                        {qualifiesForVisa ? 'Elegible para Visa' : 'No Elegible para Visa'}
                      </h4>
                      <p className="text-sm text-gray-600">
                        {qualifiesForVisa 
                          ? 'Este valor de propiedad califica para una visa de inversión colombiana.'
                          : 'El valor de la propiedad debe ser de al menos $455M COP para calificar para una visa de inversión.'
                        }
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Desglose de Gastos</h3>
                ...
                <div className="bg-emerald-50 border-2 border-emerald-200 rounded-lg p-6">
                  <div className="flex justify-between items-center">
                    <h4 className="text-xl font-bold text-emerald-900">Gastos Totales</h4>
                    <div className="text-right">
                  ...
                  <div className="mt-3 text-sm text-emerald-700">
                    {((totalFees / propertyValue) * 100).toFixed(2)}% del valor de la propiedad
                  </div>
                </div>
              </div>
            </div>
