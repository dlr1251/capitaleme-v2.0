  ...
  const services = [
    {
      ...
      subtitle: "Asistencia en Búsqueda de Propiedades",
      description: "Déjanos ayudarte a encontrar tu propiedad ideal en Colombia con orientación experta y conocimientos del mercado.",
      link: "/es/contact?service=buy",
      ...
      features: ["Búsqueda de Propiedades", "Análisis de Mercado", "Soporte Legal", "Negociación"]
    },
    {
      title: "¿Quieres Vender?",
      subtitle: "Servicio Profesional de Listado",
      description: "Maximiza el valor de tu propiedad con nuestro servicio integral de venta y experiencia en el mercado.",
      link: "/es/contact?service=sell",
      ...
      features: ["Valoración de Propiedades", "Estrategia de Marketing", "Filtrado de Compradores", "Soporte de Cierre"]
    },
    {
      title: "¿Necesitas Asesoría Legal?",
      subtitle: "Servicios Legales Inmobiliarios",
      description: "Obtén orientación legal experta para todas tus transacciones inmobiliarias y necesidades de cumplimiento.",
      link: "/es/contact?service=legal",
      ...
      features: ["Revisión de Contratos", "Debida Diligencia", "Planificación Fiscal", "Cumplimiento"]
    }
  ];
