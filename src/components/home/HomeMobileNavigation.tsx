...
const HomeMobileNavigation: React.FC<HomeMobileNavigationProps> = ({
  ...
  return (
    <>
      {/* Home Mobile Navigation - Bottom Navigation Bar */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg">
        <div className="flex items-center justify-around px-2 py-2">
          ...
          <a
            ...
            className="flex flex-col items-center justify-center w-12 h-12 rounded-lg transition-all duration-200 text-blue-600 hover:text-blue-700 hover:bg-blue-50"
            aria-label={lang === 'es' ? 'Reservar Consulta' : 'Book Consultation'}
          >
            <CalendarIcon className="w-4 h-4 mb-1" />
            <span className="text-xs font-medium">{lang === 'es' ? 'Consulta' : 'Book'}</span>
          </a>
