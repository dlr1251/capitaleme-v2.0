...
interface CLKRBottomNavigationProps {
  lang?: 'en' | 'es';
  pathname?: string;
  title?: string;
  content?: string;
...
const CLKRBottomNavigation: React.FC<CLKRBottomNavigationProps> = ({
  lang = 'en',
  pathname = '',
  title = '',
  content = ''
  ...
  return (
    <>
      {/* Bottom Navigation Bar - Only for CLKR articles */}
...
export default CLKRBottomNavigation;
