        ...
        <p className="mt-2">
          ...
          <ol className="relative border-s border-gray-200 mt-4">                  
              <li className="mb-10 ms-6 ml-4">            
                  ...
                  <h3 className="leading-tight">Choose your country</h3>
                  <p className="text-sm text-gray-500">Some visas are country-specific</p>
              </li>
              <li className="mb-10 ms-6">
                  ...
                  <h3 className="font-medium leading-tight">Bringing Spouse and Children?</h3>
                  <p className="text-sm">Some categories allow dependents</p>
              </li>
              <li className="mb-10 ms-6">
                  <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                  ...
                  <h3 className="font-medium leading-tight">Open Work Permit</h3>
                  <p className="text-sm">Defined under Colombian Labour rules</p>
              </li>
              <li className="ms-6">
                  <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                      <svg className="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                  ...
                  <h3 className="font-medium leading-tight">Accrue Time Towards Residency</h3>
                  <p className="text-sm">Make Colombia your home.</p>
              </li>
          </ol>
            ...
            >
              ...
              <div className="">
                <div className="text-sm mt-4">
                  <span className="font-bold text-secondary">Beneficiaries:</span> {visa.data.beneficiaries.includes("yes") ? "Yes" : "No"}
                </div>
