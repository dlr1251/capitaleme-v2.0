        ...
        <p className="mt-2">
          ...
          <ol class="relative border-s border-gray-200 mt-4">                  
              <li class="mb-10 ms-6 ml-4">            
                  ...
                  <h3 class="leading-tight">Choose your country</h3>
                  <p class="text-sm text-gray-500">Some visas are country-specific</p>
              </li>
              <li class="mb-10 ms-6">
                  ...
                  <h3 class="font-medium leading-tight">Bringing Spouse and Children?</h3>
                  <p class="text-sm">Some categories allow dependents</p>
              </li>
              <li class="mb-10 ms-6">
                  <span class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                  ...
                  <h3 class="font-medium leading-tight">Open Work Permit</h3>
                  <p class="text-sm">Defined under Colombian Labour rules</p>
              </li>
              <li class="ms-6">
                  <span class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                      <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                  ...
                  <h3 class="font-medium leading-tight">Accrue Time Towards Residency</h3>
                  <p class="text-sm">Make Colombia your home.</p>
              </li>
          </ol>
