import PropertyCard from '../../ui/cards/PropertyCard.jsx';
import PropertyFilters from '../../ui/forms/PropertyFilters.jsx';
...
const ExplorePropertiesSection = ({ properties = [] }: ExplorePropertiesSectionProps) => {
  ...
  const transformedProperties = (properties || []).map((property: Property) => ({
    ...
    price: `$${property.data.price.usd.toLocaleString()} USD / $${property.data.price.cop.toLocaleString()} COP`,
