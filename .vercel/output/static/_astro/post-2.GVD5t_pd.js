const e="en/post-2.mdx",t="posts",o="en/post-2",r=`
...
You can only enter the country through a legal entry point. You can see the list of legal entrance points [here](https://www.cancilleria.gov.co/sites/default/files/Normograma/docs/resolucion_uaemc_0004_2012.htm#3). 
...
> 💡 This permit is not a visa. Permits are issued by Migración Colombia officers and visas are issued by Internal Work Group of Visas and Immigration (GIT - Visas y Migración) of the Ministry of Foreign Relations. Two different entities, who apply different rules.
The permits are ruled by the [Resolución 3167 de 2019](https://www.cancilleria.gov.co/sites/default/files/Normograma/docs/resolucion_uaemc_3167_2019.htm) issued by the Special Administrative Unit - Migración Colombia.
...
Every time you leave and re-enter the country, you will be granted a new Tourism Permit for up to 90 days, but if you have already “used” (stayed in the country) more than 90 days during that calendar year, they can only give you time for up to the remaining number of days to fulfill your permitted 180 days in that year.`,i={title:"Border controls",pubDate:new Date(16573248e5),description:"Some considerations about the migration check at the airport or border",readTime:"6 min",author:"Daniel Luque",image:{url:"",alt:"Thumbnail of Astro arcs."},tags:["astro","blogging","learning in public","successes"]},a={type:"content",filePath:"/Users/danielluque/Projects/capitalm-website/src/content/posts/en/post-2.mdx",rawData:void 0};export{a as _internal,r as body,t as collection,i as data,e as id,o as slug};
